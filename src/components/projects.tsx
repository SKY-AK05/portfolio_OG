    ...
    <div ref={sectionRef} className="container mx-auto px-6 py-20">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-6xl font-bold text-foreground mb-6">Projects</h2>
        ...
        <div ref={projectsGridRef} className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {projects.map((project, index) => (
            <div
              key={project.id}
              className={`project-bubble ${project.colorClass} border-2 border-foreground rounded-3xl p-8 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-lg relative overflow-hidden`}
            ...
            >
              ...
              <p className="font-body text-sm text-foreground/70 mb-4">{project.subtitle}</p>
              ...
              <div className="flex flex-wrap gap-2">
                {projects
                  ...
                  ?.tech.map((tech) => (
                    <span
                      key={tech}
                      className="bg-primary text-primary-foreground px-3 py-1 rounded-full border-2 border-foreground font-body text-sm"
                    >
                      {tech}
                    </span>
                  ))}
